...
<head>
    ...
    <title>Mon Carnet - Ajouter un contact</title>
                ...
                <div class="col-md-8 col-lg-7">
                    <div class="form-modern">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="mt-3">Ajouter un contact</h2>
                        ...
                        <form action="index.php?action=store" method="POST" enctype="multipart/form-data" id="contactForm">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea id="adresse" name="adresse" rows="3" class="form-control border-start-0" 
                                              placeholder="12 rue de Paris, 75001 Paris" required><?= htmlspecialchars($old['adresse'] ?? '') ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="upload-zone" onclick="document.getElementById('photo').click()">
                                    ...
                                    <p class="mb-0 text-muted">Cliquez ou glissez une image ici</p>
